...
<label id="ctr">
	<h2>COMP 248: OBJECT-ORIENTED PROGRAMMING I</h2>
</label>
<label id="ctr"><a href="https://github.com/DukeNgn/COMP248-OOP1" target="_blank">REPOSITORY</a></label>
<br />

<h3><strong>FINAL PROJECT: QWIXX GAME</strong></h3>
<h4 id="ctr"><a href="https://github.com/DukeNgn/COMP248-OOP1/tree/master/Assignment%234" target="_blank">[Source Code]</a></h4>
<div class="row">
	<div class="column">
...
<label id="ctr">
	<h2>COMP 249: OBJECT-ORIENTED PROGRAMMING II</h2>
</label>
<label id="ctr"><a href="https://github.com/DukeNgn/COMP249-OOP2-with-java">REPOSITORY</a></label>

<!--showcase 1: extract Dictionary -->
<h3><strong>NO.1: DICTIONARY EXTRACT TOOL</strong></h3>
<h4 id="ctr"><a href="https://github.com/DukeNgn/COMP249-OOP2-with-java/tree/master/ArrayList%20%26%20LinkedArray/subDictionaryCreator" target="_blank">[Source Code]</a></h4>
<div class="row">
	<div class="column">
		<img src="./projectStyle/image/COMP249/before.png" alt="beforeDictionary" style="width:100%">
	</div>
	<div class="column">
		<img src="./projectStyle/image/COMP249/result.gif" alt="ResultDictionary" style="width:100%">
	</div>
</div>
<br />
<h4 id="ctr"> Dictionary extract tool: Extract, and sort words alphabetically from a source text file</h4>
...
<div class="row">
	<div class="column">
		<img src="./projectStyle/image/COMP249/beforeLatex.png" alt="" style="width:100%">
	</div>
	<div class="column">
		<img src="./projectStyle/image/COMP249/ProcessingLatex.gif" alt="" style="width:100%">
	</div>
</div>
<br />
<h5 id="ctr"> EXAMPLE OF INPUT FILE & SCREENSHOT DURING PROCESSING </h5>

<div class="row">
	<div class="column">
		<img src="./projectStyle/image/COMP249/ACM.png" alt="" style="width:100%">
	</div>
	<div class="column">
...
<!-- PROJECT showcase: POWERLINE-STYLE FOR TERMINAL -->
<label id='ctr'>
	<h2>CONFIGURE POWER-LINE STYLE FOR TERMINAL</h2>
</label>
<label id='ctr'><a href='./powerLineConfig.php'>DETAIL PAPER</a></label>
<blockquote>
	A detailed guideline on how to configure terminal shell to be <strong>powerline-style</strong> with <strong>ZSH Shell</strong> and <strong>Fish Shell</strong>.
	<br />
	Moreover, this guideline also introduces reader with knowledge of some popular shell package manager currently.
	Therefore, reader can customize with their preferred settings, themes, or plugins.
</blockquote>
...
<label id="ctr">
	<h2>SIDE PROJECTS AND PAPERS</h2>
</label>
<!--showcase 1: MANA201 -->
